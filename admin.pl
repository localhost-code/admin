...
system "color 0a";
print"\n";
print  "\t CARI    /A        |DDDDDDD     |MM       MM |I  |NN      |N\n";
print  "\t        /A A       |D      D    |M M     M|M |I  |N N     |N\n";
print  "\t       /A   A      |D       D   |M  M   M |M |I  |N  N    |N\n";
print  "\t      /A     A     |D        D  |M   M M  |M |I  |N   N   |N\n";
print  "\t     /A       A    |D LOGIN   D |M   MM   |M |I  |N    N  |N\n";
print  "\t    /A         A   |D        D  |M        |M |I  |N     N |N\n";
print  "\t   /A           A  |D       D   |M        |M |I  |N      N|N\n";
print  "\t  /A             A |DDDDDDDD    |M        |M |I  |N       NN\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>   MENCARI TEMPAT LOGIN SEBUAH WEBSITE   >\n";
print "\t>     | INDONESIAN CYBER SECURITY |       >\n";
print "\t>  EDITOR BY:Eko Saputra (evsystem)       >\n";
print "\t>  Version :1.2.0                         >\n";
print "\t>  follow me on GitHub : ekovegeance      >\n";
print "\t>  twitter :ekovegeance7                  >\n";
print "\t>         ADMIN ADMIN ADMIN ADMIN ADMIN   >\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";
